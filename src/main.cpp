...
const string strMessageMagic = "CRTCoin Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    for (unsigned int i = 0; i < vout.size(); i++)
    {
        ...
        // CRTCoin: enforce minimum output amount for user transactions until 1 May 2014 04:00:00 GMT
...
int64 GetProofOfWorkReward(unsigned int nBits)
{
    ...
    // CRTCoin: subsidy is cut in half every 64x multiply of PoW difficulty
    ...
    if (nBestHeight == 0)
        return nSubsidy * FIRST_BLOCK_PROOF_OF_WORK_MULTIPLIER;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, bool bCoinYearOnly)
{
    ...
    if(fTestNet || nTime > STAKE_SWITCH_TIME)
    {
        ...
        // CRTCoin: A reasonably continuous curve is used to avoid shock to market
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CRTCoin
    bool fStrictPayToScriptHash = true; // Always active in CRTCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CRTCoin: check proof-of-stake block signature
...
//        if (IsFirstBlock())
//            nReward *= FIRST_BLOCK_PROOF_OF_WORK_MULTIPLIER;
        ...
        if(!fTestNet && fCheckSig)
        {
            ...
            // CRTCoin: check proof-of-work block signature
...
// crtcoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CRTCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://bitcointalk.org/index.php?topic=189350.msg5529246#msg5529246";
        CTransaction txNew;
        txNew.nTime = 1394232581;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = !fTestNet ? 1394232581 : 1394232581;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1753200 : 70730;

        //// debug print
        block.print();
        assert(block.hashMerkleRoot == uint256("0xfb543ca34a47ef2d0896b93dd2eca6ba70855bcefda29df1b126dac56dd3269c"));
