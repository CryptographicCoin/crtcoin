...
CRTCoin official development tree

CRTCoin - a hybrid scrypt PoW + PoS based cryptocurrency.
...
* Maximum PoW reward is 8 coins
* Maximum PoS reward is 2 coins
...
official, stable release versions of CRTCoin.
